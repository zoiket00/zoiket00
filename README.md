...
|---|---------|-------|--------|
| 01 | **[PC Optimiz Pro X](https://github.com/zoiket00)** — Optimizador Windows profesional. Clean Architecture, 342+ tests, rollback HMAC-SHA256 | `C#` `.NET 8` `WPF` | 🔨 En desarrollo |
| 02 | **[FIORE MAESTRO](https://github.com/zoiket00/JARVIS-OS)** — Asistente IA personal. Ejecuta tareas reales en tu ecosistema digital | `Python` `Claude API` `FastAPI` `Docker` | 🔨 En desarrollo |
| 03 | **[Aprender Para Emprender](https://github.com/zoiket00/Aprender-Para-Emprender)** — Plataforma edtech para emprendedores | `Next.js` `TypeScript` `Supabase` | 🔨 En desarrollo |
| 04 | **[CIDI Asistencia 2026](https://github.com/zoiket00/cidi-asistencia-2026-)** — Sistema de asistencia para institución educativa real | `HTML` `JS` `TypeScript` | ✅ Entregado |
